...
import com.leyoho.examples.controller.FishesController;
...
public abstract class AbstractControllerTest extends AbstractTest {
	...
	/**
     * Prepares the test class for execution of web tests. Builds a MockMvc
     * instance using stand-alone configuration facilitating the injection of
     * Mockito resources into the controller class.
     * @param controller A controller object to be tested.
     */
	protected void setUp(FishesController controller) {
